...
public class checkSfJdbcConns {
    ...
    public static void main(String[] args) {
        System.out.println("JOE::Snoflake JDBC check test, with jdbcUrl, start...");
        System.out.println("\tw/ocspFailOpen=true, w/insecureMode=true");

        checkSfJdbcConns my = new checkSfJdbcConns();
        if ( args.length == 1 ) {
