...
public class jvPalm {
    String[] msgs = new String[] {
            ...
            "  $ java -cp \"/svc/palm/sfAgent/drivers/*:/svc/palm/sfAgent/bin/*\" joe.sf2my.checkMysqlJdbcConn 0",
            "",
            "included methods are bellow:",
            "  >> joe.sf2my.checkMysqlJdbcConn [0..1]",
            "     0: mysql://palmmysqldb:3306, 1: mariadb://palmmysqldb:3306",
            "  >> joe.sf2my.checkSfJdbcConn [0..3]",
            "     0,1: Internet atixoaj,jx75304, 2,3: Private atixoaj,jx75304",
            "  >> joe.sf2my.mvSFM_QueryHistory [0..1] (minutes | Date Hour)",
